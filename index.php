              ...
              <ul class="leven-classic-menu site-main-menu">
                <li class="menu-item menu-item-has-children current-menu-item">
                  ...
                  <ul class="sub-menu">
                    ...
                    <li class="menu-item">
                      <a href="index-2.html">Personal</a>
                    </li>
                  </ul>
                </li>
                      ...
                      <div class="row flex-v-align">
                        ...
                        <div class="col-sm-12 col-md-5 col-lg-5">
                          <div class="home-photo">
                            <div class="hp-inner" style="background-image: url(img/main_photo.jpg); crop: inset-rect">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-7">
                          <div class="home-text hp-left">
                            ...
                            <h1>Nazmus Sakib</h1>
                            <p>Productivity and professionalism are my main subject. I am a MERN stack developer with 2 years of working experience. Besides this, I have Strong knowledge of Laravel & Vue. Mobile technology is my passionate hobby.</p>
        ...
        <footer class="site-footer clearfix">
          <div class="footer-social">
            <ul class="footer-social-links">
              <li>
                <a href="https://www.linkedin.com/in/sakib-57/" target="_blank">LinkdIn</a>
              </li>

              <li>
                <a href="https://www.facebook.com/sakib57" target="_blank">Facebook</a>
              </li>
            </ul>
          </div>
              
          <div class="footer-copyrights">
            <p>© 2022 All rights reserved. Nazmus Sakib</p>
          </div>
        </footer>
        <!-- /Footer -->
